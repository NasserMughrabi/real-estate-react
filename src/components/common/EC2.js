...
//   // Function to wait for instance state to be running and status checks passed
//   const waitForInstanceRunning = async () => {
//     while (true) {
//       try {
//         // Describe instance status
//         const instanceStatus = await ec2Client
//           .send(
//             new DescribeInstanceStatusCommand({ InstanceIds: [EC2InstanceId] })
//           )
...
//           // Check if instance is running and status checks passed
//           if (instanceState === "running" && systemStatus === "ok") {
//             console.log("Instance is running and status checks passed.");
//             setEC2Status("EC2 is running");
//             break;
//           }
//         }
//       } catch (err) {
//         console.error("Error describing instance status:", err);
//       }
